...
const AudioElement: React.FC<AudioElementProps> = ({ audioURL, title }) => {
    ...
    return (
        <div className="w-full flex flex-col gap-8 items-center sm:items-start bg-gray-100">
            ...
            <button className="w-full bg-white text-lg py-2 px-4 mt-4 rounded-lg">
                ...
                {isPlaying && 
                    <div className="flex items-center w-full">
                        <svg onClick={handlePauseAudio} width="30" height="30" viewBox="0 0 20 20" className="mr-2 cursor-pointer" fill="none" xmlns="http://www.w3.org/2000/svg">
