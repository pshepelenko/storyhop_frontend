        ...
        <div className="px-4 py-0 bg-white text-gray-800 font-sans">
            ...
            <div className="mt-8 space-y-6">
                ...
                <ul className="list-disc list-inside space-y-2 text-gray-700">
                    ...
                    <li>
                        <span className="font-semibold">🧩 Проработка сложных ситуаций:</span> Встроенный механиз сказкотерапии позволяет ребенку легче пережить сложные жизненные ситуации (например, развод родителей или переезд в другую страну).
                    </li>                    
                </ul>
            </div>
